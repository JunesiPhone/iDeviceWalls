//
//  PLStaticWallpaperImageViewController.h
//  idevicewallsapp
//
...
#ifndef PLStaticWallpaperImageViewController_h
#define PLStaticWallpaperImageViewController_h


#endif /* PLStaticWallpaperImageViewController_h */
